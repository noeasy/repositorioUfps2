...
<html>
	...
	<link type="text/css" rel="stylesheet" href="https://ww2.ufps.edu.co/assets/plugins/layer-slider/layerslider/css/layerslider.min.css">
	    ...
	    <link rel="stylesheet" href="<%= request.getContextPath() %>/static/css/bootstrap/footer-v1.min.css" type="text/css" />
...
<!--
<div class="container banner" style="padding:0px;">
	<div class="row">
        ...
        <div class="col-md-4 col-sm-4 col-xs-5 transparente"><img class="img-responsive" src="<%= request.getContextPath() %>/image/logo.png" alt="Logo Ufps" />
        </div>

   <div class="col-md-2 col-ms-1 col-xs-2 pull-right transparente"><img class="header-banner pull-right" src="<%= request.getContextPath() %>/image/escudo_colombia.png" alt="Escudo de colombia" />
    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-4 col-xs-5">
                            <a href="https://ww2.ufps.edu.co/">
                                <img id="logo-header"
                                     src="https://ww2.ufps.edu.co/public/imagenes/template/header/logo_ufps.png" alt="Logo UFPS">
                            </a>
                        </div>
                        <div class="col-md-2 col-ms-1 col-xs-2 pull-right">
                            <a href="http://www.colombia.co/"><img class="header-banner"
                                                                   src="https://ww2.ufps.edu.co/public/imagenes/template/header/escudo_colombia.png"
